        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i><?php echo e(trans('english.UPDATE_USER_PROFILE')); ?> </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'users/editProfile', 'files'=> true, 'class' => 'form-horizontal', 'id' => 'edit-profile'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('first_name',Auth::user()->first_name, array('id'=> 'UserFirstName', 'class' => 'form-control', 'placeholder' => 'Enter First Name'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('last_name',Auth::user()->last_name, array('id'=> 'UserLastName', 'class' => 'form-control', 'placeholder' => 'Enter Last Name', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('official_name',Auth::user()->official_name, array('id'=> 'userOfficialName', 'class' => 'form-control', 'placeholder' => 'Enter Official Name', 'required' => 'true'))); ?>
                                ...
                                <!--<div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            ...
                                            <?php echo e(Form::email('email',Auth::user()->email, array('id'=> 'UserEmail', 'placeholder' => 'Email Address', 'class' => 'form-control'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon">
                                            ...
                                            <?php echo e(Form::text('phone_no',Auth::user()->phone_no, array('id'=> 'userPhoneNumber', 'class' => 'form-control', 'placeholder' => 'Enter Phone Number'))); ?>
                            ...
                            <div class="col-md-5">
                                <div class="form-group last">
                                    <label class="control-label col-md-3"> <?php echo e(trans('english.PHOTO')); ?>: </label>
                                    <div class="col-md-9">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                <?php if(isset(Auth::user()->photo)): ?>
                                                    <img src="<?php echo e(URL::to('/')); ?>/public/uploads/user/<?php echo e(Auth::user()->photo); ?>" alt="<?php echo e(Auth::user()->official_name); ?>"> 
                                                <?php else: ?>
                                                    <img src="<?php echo e(URL::to('/')); ?>/public/img/no-image.png" alt="<?php echo e(Auth::user()->official_name); ?>"> 
                                                <?php endif; ?>
                                            </div>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/users/user_profile.blade.php ENDPATH**/ ?>
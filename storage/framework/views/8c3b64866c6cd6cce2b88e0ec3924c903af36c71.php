        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-badge"></i><?php echo e(trans('english.CREATE_NEW_RANK')); ?> </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'rank', 'class' => 'form-horizontal', 'id'=>'createRank'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('title', Request::get('title'), array('id'=> 'rankTitle', 'class' => 'form-control', 'placeholder' => 'Enter Rank Title'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::number('order', Request::get('order'), array('id'=> 'rankOrder', 'min' => 0, 'class' => 'form-control', 'placeholder' => 'Enter Rank Order', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('status', array('active' => 'Active', 'inactive' => 'Inactive'), Request::get('status'), array('class' => 'form-control dopdownselect-hidden-search', 'id' => 'rankStatus'))); ?>
...
<script type="text/javascript">
	$(document).on("submit", '#createRank', function (e) {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/rank/create.blade.php ENDPATH**/ ?>
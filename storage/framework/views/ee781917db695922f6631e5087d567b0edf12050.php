        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i><?php echo e(trans('english.CREATE_NEW_USER')); ?> </div>
                    <div class="tools">
                    </div>
                </div>
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'users', 'files'=> true, 'class' => 'form-horizontal', 'id'=>'userCreate'))); ?>
                        ...
                        <div class="row">
                            <div class="col-md-7">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('group_id', $groupList, Request::old('group_id'), array('class' => 'form-control dopdownselect', 'id' => 'userGroupId'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('designation_id', $designationList, Request::old('designation_id'), array('class' => 'form-control dopdownselect', 'id' => 'userRankId'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('appointment_id', $appointmentList, Request::old('appointment_id'), array('class' => 'form-control dopdownselect', 'id' => 'userApprointmentId'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('last_name', Request::old('last_name'), array('id'=> 'UserLastName', 'class' => 'form-control', 'placeholder' => 'Enter Last Name', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('branch_id', $branchList, Request::old('branch_id'), array('class' => 'form-control dopdownselect', 'id' => 'userBranchId'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::text('official_name', Request::old('official_name'), array('id'=> 'userOfficialName', 'class' => 'form-control', 'placeholder' => 'Enter Official Name', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo e(trans('english.PASSWORD')); ?> :<span class="required"> *</span></label>
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <?php echo e(Form::password('password', array('id'=> 'UserPassword', 'class' => 'form-control', 'placeholder' => 'Password', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label"><?php echo e(trans('english.CONFIRM_PASSWORD')); ?> :<span class="required"> *</span></label>
                                    <div class="col-md-8">
                                        <div class="input-group">
                                            <?php echo e(Form::password('password_confirmation', array('id'=> 'UserConfirmPassword', 'class' => 'form-control', 'placeholder' => 'Confirm Password', 'required' => 'true'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <div class="input-icon">
                                            ...
                                            <?php echo e(Form::text('phone_no',Request::old('service_no'), array('id'=> 'userPhoneNumber', 'class' => 'form-control', 'placeholder' => 'Enter Phone Number'))); ?>
                                ...
                                <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        <?php echo e(Form::select('status', $status, Request::old('status'), array('class' => 'form-control dopdownselect-hidden-search', 'id' => 'userStatus'))); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/users/create.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.CONFIRMED')); ?>
                ...
                <div class="portlet-body">
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'confirmed/filter', 'class' => '', 'id' => 'jobTitleFilter'))); ?>
...
<!--                                    <td class="text-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-success btn-xs tooltips" data-placement="top" data-rel="tooltip" data-original-title="Particapated" data-id ="<?php echo e($value->id); ?>" title="Particapated" id="participated" data-container="body" data-trigger="hover" data-placement="top">
...
//                    processData: false,
                    ...
                    success: function (res) {
                        ...
                        location = "<?php echo e(URL::to('/confirmed')); ?>";
                    },
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/confirmed/index.blade.php ENDPATH**/ ?>
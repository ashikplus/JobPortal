...
<!--                                    <td class="text-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            ...
                                            <a class="btn btn-success btn-xs tooltips" data-placement="top" data-rel="tooltip" data-original-title="Select for Interview" data-id ="<?php echo e($value->id); ?>" title="Select for Interview" id="selectForInterview" data-container="body" data-trigger="hover" data-placement="top">
...
<script type="text/javascript">
    ...
    $(document).on('click', "#selectForInterview", function (e) {
...
//                    processData: false,
                    ...
                    beforeSend: function () {
                        $("#selectForInterview").prop('disabled', true);
                        App.blockUI({boxed: true});
                    },
                    success: function (res) {
                        toastr.success(res.message, res.heading, options);
                    ...
                    error: function (jqXhr, ajaxOptions, thrownError) {
                        ...
                        $("#selectForInterview").prop('disabled', false);
                        App.unblockUI();
                    }
                }); //ajax
            }
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/reviewed/index.blade.php ENDPATH**/ ?>
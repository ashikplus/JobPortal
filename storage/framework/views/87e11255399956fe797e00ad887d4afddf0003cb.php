...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i><?php echo app('translator')->get('english.ALBUM_LIST'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('gAlbum/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo e(trans('english.CREATE_NEW')); ?>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->cover_photo)) { ?>
                                    <img width="70"  src="<?php echo e(URL::to('/')); ?>/public/uploads/website/gallery/album/<?php echo e($target->cover_photo); ?>" alt="<?php echo e($target->title); ?>"/>
                                <?php } else { ?>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    <?php echo e(Form::open(array('url' => 'gAlbum/' . $target->id, 'id'=>'delete'))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('gAlbum/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/gallery/GAlbum/index.blade.php ENDPATH**/ ?>
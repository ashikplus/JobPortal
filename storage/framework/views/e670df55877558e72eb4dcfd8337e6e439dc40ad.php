        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.SELECTED_FOR_INTERVIEW')); ?>
...
<!--                                    <td class="text-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            ...
                                            <a class="btn btn-warning btn-xs tooltips" data-placement="top" data-rel="tooltip" data-original-title="Click here to set Activity log" data-toggle="modal" data-id ="<?php echo e($value->id); ?>" href="#modalSetActivity" title="Click here to set Activity log" id="setActivityLog" data-container="body" data-trigger="hover" data-placement="top">
...
<script type="text/javascript">
    $(document).on('click', '#setActivityLog', function (e) {
        e.preventDefault();
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/selectForInterview/index.blade.php ENDPATH**/ ?>
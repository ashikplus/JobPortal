        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.VIEW_RECRUITED_APPLICATION')); ?>
                ...
                <div class="portlet-body">
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'recruitedApplicant/filter', 'class' => '', 'id' => 'jobTitleFilter'))); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/recruited/index.blade.php ENDPATH**/ ?>
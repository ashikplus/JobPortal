...
if(!empty($target->nigotiable)){
    ...
    if(!empty($target->salary_from) && !empty($target->salary_to) || !empty($target->salary_to)){
        if(empty($target->salary_from)){
            $salaryRange = "0 to ".$target->salary_to;
        }else{
            $salaryRange = $target->salary_from." to ".$target->salary_to;
        }
        
    }else{
        $salaryRange = $target->salary_from;
    }
}
            ...
            <div class="col-md-12 pb-15">
                <div class="row">
                    <div class="col-md-8 paper-shadow ">
                        ...
                        <p class="font-weight-bold">Educational Requirements</p>
                        ...
                        <p class="font-weight-bold">Other Benefits</p>
...
<?php /**PATH D:\xampp\htdocs\dysin\resources\views/website/frontend/template/jobDetails.blade.php ENDPATH**/ ?>
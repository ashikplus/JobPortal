...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i><?php echo app('translator')->get('english.NEWS_AND_EVENTS'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('newsAndEvents/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo e(trans('english.CREATE_NEW')); ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter"><?php echo app('translator')->get('english.FEATURED_IMAGE'); ?></th>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->featured_image)) { ?>
                                    <img width="150" height="70" src="<?php echo e(URL::to('/')); ?>/public/uploads/website/NewsAndEvents/<?php echo e($target->featured_image); ?>" alt="<?php echo e($target->caption); ?>"/>
                                <?php } else { ?>
                                    <img width="150" height="70" src="<?php echo e(URL::to('/')); ?>/public/img/no-image.png" alt="<?php echo e($target->full_name); ?>"/>
                                <?php } ?>
                            </td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    <?php echo e(Form::open(array('url' => 'newsAndEvents/' . $target->id, 'id'=>'delete'))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('newsAndEvents/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/website/NewsAndEvents/index.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.VIEW_DISCARDED_APPLICATION')); ?>

                    </div>
                </div>
                <div class="portlet-body">
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'discardedApplication/filter', 'class' => '', 'id' => 'jobTitleFilter'))); ?>
                                ...
                                <tr class="contain-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-warning btn-xs tooltips application-details" data-toggle="modal" data-target="#view-modal" href="#view-modal" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.VIEW_APPLICATION_DETAILS')); ?>" data-id ="<?php echo e($value->id); ?>" title="<?php echo e(trans('english.VIEW_APPLICATION_DETAILS')); ?>" id="applicationDetails_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-danger btn-xs tooltips pending" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.PENDING')); ?>" data-id ="<?php echo e($value->id); ?>" title="<?php echo e(trans('english.PENDING')); ?>" id="pending_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
...
//                    processData: false,
                    ...
                    success: function (res) {
                        ...
                        location = "<?php echo e(URL::to('/discardedApplication')); ?>";
                    },
                    error: function (jqXhr, ajaxOptions, thrownError) {
                        if (jqXhr.status == 400) {
                            var errorsHtml = '';
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-7.4.9\htdocs\swapnoloke\resources\views/discarded/index.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.VIEW_PENDING_APPLICANTION')); ?>
...
<!--                                    <td class="text-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-danger btn-xs discard  tooltips" data-rel="tooltip" data-toggle="modal" data-target="#viewModal" data-id="<?php echo e($value->id); ?>" href="#viewModal" id="discard_<?php echo e($value->id); ?>" title="<?php echo e(trans('english.DISCARD')); ?>" data-container="body" data-trigger="hover" data-placement="top">

                                                <i class='fa fa-ban'></i>
                                            </a>
                                            <a class="btn btn-primary btn-xs review tooltips" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.REVIEWED')); ?>" data-toggle="modal" data-id ="<?php echo e($value->id); ?>" href="#viewModal" title="<?php echo e(trans('english.REVIEWED')); ?>" id="reviewed_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-7.4.9\htdocs\swapnoloke\resources\views/applicant/index.blade.php ENDPATH**/ ?>
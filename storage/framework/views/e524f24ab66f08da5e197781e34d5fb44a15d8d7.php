        ...
        <div class="col-md-12">
            <div class="row justify-content-center">
                ...
                <div class="col-md-5 mt-5 mb-5 main-div">
                    ...
                    <?php echo e(Form::open(array('role' => 'form', 'url' => '', 'class' => 'form-horizontal apply', 'id' => 'apply'))); ?>

                    <?php echo e(Form::hidden('circular_id', $id)); ?>

                    <?php echo e(Form::hidden('title', $title)); ?>

<!--                    <h5 class="text-center">Applying for position of<span class="text-success"><?php echo e($title); ?></span> Post</h5>-->
                    <?php echo app('translator')->get('english.APPLYING_POSITION', ['title' => $title]); ?>
                    <!-- Progress bar -->
                    ...
                    <div class="form-step form-step-active">
                        <div class="input-group ml-21">
                            <label for="name"><?php echo e(trans('english.NAME')); ?>:<span class="required"> *</span></label>
                            <?php echo e(Form::text('name', Request::get('name'), array('id'=> 'name', 'class' => ''))); ?>

                            <span class="help-block text-danger"> <?php echo e($errors->first('name')); ?></span>
                        </div>
                        <div class="input-group ml-21">
                            <label for="email"><?php echo e(trans('english.EMAIL')); ?>:<span class="required"> *</span></label>
                            <?php echo e(Form::email('email', Request::get('email'), array('id'=> 'email', 'class' => ''))); ?>

                            <span class="help-block text-danger"> <?php echo e($errors->first('email')); ?></span>
                        </div>
                        <div class="input-group ml-21">
                            <label for="phone"><?php echo e(trans('english.PHONE')); ?>:<span class="required"> *</span></label>
                            <?php echo e(Form::text('phone', Request::get('phone'), array('id'=> 'phone', 'class' => ''))); ?>
                        ...
                        <div class="justify-content-center d-flex mb-5">
                            <button type="button" class="btn mr-2 btn-primary btn-next proceed" id="btn-next">
                                <?php echo e(trans('english.PROCEED')); ?>

                            </button>
                            <a href="<?php echo e(URL::to('jobs/details',$id)); ?>">
...
<script type="text/javascript">
    $(function () {
        ...
        $(document).on("click", ".proceed", function (e) {
            ...
            $.ajax({
                url: "<?php echo e(URL::to('jobs/intro')); ?>",
                type: 'POST',
                cache: false,
                contentType: false,
                processData: false,
...
//                    console.log(storageCode);
            $.ajax({
                url: "<?php echo e(URL::to('jobs/verify')); ?>",
                type: 'POST',
//                        cache: false,
//                        contentType: false,
//                        processData: false,
...
//                    console.log(cv);
            ...
            $.ajax({
                url: "<?php echo e(URL::to('jobs/store')); ?>",
                type: 'POST',
                cache: false,
                contentType: false,
                processData: false,
        ...
        function verificationCountDown() {
            ...
            countDown = setInterval(function () {
                ...
                if (distance <= 0) {
                    var circularId = $("#circularId").val();
                    localStorage.clear();
                    location = "<?php echo e(URL::to('/jobs/details/')); ?>/" + circularId;
                }
            }, 1000);
        }
    });
...
<?php echo $__env->make('website.layouts.footer', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?> <?php /**PATH E:\xampp-7.4.9\htdocs\swapnoloke\resources\views/website/frontend/template/apply.blade.php ENDPATH**/ ?>
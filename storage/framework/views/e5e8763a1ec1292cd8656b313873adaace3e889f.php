...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i><?php echo app('translator')->get('english.CREATE_PROGRAM'); ?>
            </div>
        </div>
        <div class="portlet-body form">
            <?php echo Form::open(array('group' => 'form', 'url' => 'ourPrograms', 'files'=> true, 'class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?php echo Form::select('program_code', $codeList, null, ['id'=> 'programCode', 'class' => 'form-control js-source-states','autocomplete'=>'off']); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/website/OurPrograms/create.blade.php ENDPATH**/ ?>
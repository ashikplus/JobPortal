...
<div class="page-content">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            <?php echo Form::open(array('group' => 'form', 'url' => 'ourSpecialty', 'files'=> true, 'class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" for="title"><?php echo app('translator')->get('english.CAPTION'); ?> :<span class="text-danger"> *</span></label>
                            <div class="col-md-5">
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="<?php echo e(URL::to('/ourSpecialty'.Helper::queryPageStr($qpArr))); ?>" class="btn btn-circle btn-outline grey-salsa"><?php echo app('translator')->get('english.CANCEL'); ?></a>
                    </div>
                </div>
            </div>
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/website/OurSpecialty/create.blade.php ENDPATH**/ ?>
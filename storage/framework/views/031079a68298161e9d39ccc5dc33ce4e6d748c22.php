...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i><?php echo app('translator')->get('english.UPLOAD_GALLERY_PHOTO'); ?>
            </div>
        </div>
        <div class="portlet-body form">
            <?php echo Form::open(array('group' => 'form', 'url' => 'gallery', 'files'=> true, 'class' => 'form-horizontal')); ?>
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group">
                            <label class="control-label col-md-3" for="caption"><?php echo app('translator')->get('english.CAPTION'); ?> :<span class="text-danger"> *</span></label>
                            <div class="col-md-5">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" for="albumId"><?php echo app('translator')->get('english.ALBUM'); ?> :<span class="text-danger"> *</span></label>
                            <div class="col-md-5">
                                <?php echo Form::select('album_id', $albumList, null, ['id'=> 'albumId', 'class' => 'form-control js-source-states','autocomplete'=>'off']); ?>

                                <span class="text-danger"><?php echo e($errors->first('album_id')); ?></span>
                            </div>
                        </div>
                        ...
                        <div class="form-group last">
                            <label class="control-label col-md-3"><?php echo app('translator')->get('english.GALLERY_IMAGE'); ?> :<span class="text-danger"> *</span></label>
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    ...
                                    <div>
                                        ...
                                        <div class=""><span class="text-danger"><?php echo e($errors->first('gallery_img')); ?></span></div>
                                    </div>
                                </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <?php echo Form::select('order_id', $orderList, null, ['id'=> 'order_id', 'class' => 'form-control js-source-states','autocomplete'=>'off']); ?>
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="<?php echo e(URL::to('/gallery'.Helper::queryPageStr($qpArr))); ?>" class="btn btn-circle btn-outline grey-salsa"><?php echo app('translator')->get('english.CANCEL'); ?></a>
                    </div>
                </div>
            </div>
            <?php echo Form::close(); ?>
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/gallery/create.blade.php ENDPATH**/ ?>
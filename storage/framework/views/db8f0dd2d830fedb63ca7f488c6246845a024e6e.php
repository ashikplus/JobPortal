...
<div class="page-sidebar-wrapper">
    ...
    <div class="page-sidebar navbar-collapse collapse">
        ...
        <ul class="page-sidebar-menu  page-header-fixed" data-keep-expanded="false" data-auto-scroll="true" data-slide-speed="200" style="padding-top: 20px">
            ...
            <li class="nav-item <?php echo (in_array($currentControllerName, array('applicant', 'discarded', 'reviewed', 'selectForInterview','confirmed','participated','recruited'))) ? 'start active open' : ''; ?>">
                <a href="javascript:;" class="nav-link nav-toggle">
                    <i class="icon-users"></i>
                ...
                <ul class="sub-menu">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'discarded') ? 'start active open' : ''; ?>">
                        <a href="<?php echo e(URL::to('discarded')); ?>" class="nav-link ">
                            <span class="title"><?php echo e(trans('english.DISCARDED')); ?></span>
                        </a>
                    </li>

                    <li class="nav-item <?php echo ($currentControllerName == 'reviewed') ? 'start active open' : ''; ?>">
                        <a href="<?php echo e(URL::to('reviewed')); ?>" class="nav-link ">
                    ...
                    <li class="nav-item <?php echo ($currentControllerName == 'confirmed') ? 'start active open' : ''; ?>">
                        <a href="<?php echo e(URL::to('confirmed')); ?>" class="nav-link ">
                            <span class="title"><?php echo e(trans('english.CONFIRMED')); ?></span>
                        </a>
                    </li>
                    
                    <li class="nav-item <?php echo ($currentControllerName == 'participated') ? 'start active open' : ''; ?>">
                        <a href="<?php echo e(URL::to('participated')); ?>" class="nav-link ">
                            <span class="title"><?php echo e(trans('english.PARTICIPATED')); ?></span>
                        </a>
                    </li>
                    
                    <li class="nav-item <?php echo ($currentControllerName == 'recruited') ? 'start active open' : ''; ?>">
                        <a href="<?php echo e(URL::to('recruited')); ?>" class="nav-link ">
...
<?php /**PATH D:\xampp\htdocs\dysin\resources\views/includes/sidebar.blade.php ENDPATH**/ ?>
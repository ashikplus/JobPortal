        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="icon-badge"></i><?php echo e(trans('english.CREATE_NEW_DESIGNATION')); ?> </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'designation', 'class' => 'form-horizontal', 'id'=>'createDesignation'))); ?>
...
<script type="text/javascript">
	$(document).on("submit", '#createDesignation', function (e) {
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/designation/create.blade.php ENDPATH**/ ?>
...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i><?php echo app('translator')->get('english.DELIVERED'); ?>
            </div>
            <div class="actions">
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            <?php echo Form::open(array('group' => 'form', 'url' => 'orderSate/delivered/deliveredFilter','class' => 'form-horizontal')); ?>
    ...
    $(document).on("click", "#btn-submit", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                setTimeout(window.location.replace('<?php echo e(URL::to("orderSate/delivered")); ?>'), 500);
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/website/orderState/delivered.blade.php ENDPATH**/ ?>
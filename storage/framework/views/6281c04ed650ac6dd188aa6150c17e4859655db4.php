...
//                                dd($value->salary_type);
                                ...
                                if (!empty($value->nigotiable)) {
                                    ...
                                    if (!empty($value->salary_from) && !empty($value->salary_to) || !empty($value->salary_to)) {
                                        if (empty($value->salary_from)) {
                                            $salaryRange = "0 to " . $value->salary_to;
                                        } else {
                                            $salaryRange = $value->salary_from . " to " . $value->salary_to;
                                        }
                                    } else {
                                        $salaryRange = $value->salary_from;
                                    }
                                }
                                ?>
                                <tr class="contain-center">
                                    ...
                                    <td><?php echo e($salaryRange." ".$salaryType); ?></td>
                                    <td><?php echo date('d F Y',strtotime($value->submission_date)); ?></td>
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            ...
                                            <a class="btn btn-primary btn-xs" href="<?php echo e(URL::to('circular/' . $value->id . '/edit'.Helper::queryPageStr($qpArr))); ?>" title="Edit User" data-container="body" data-trigger="hover" data-placement="top">
                                                <i class="fa fa-edit"></i>
                                            </a>

                                            <a class="tooltips" data-toggle="modal" data-target="#view-modal" data-id="<?php echo e($value->id); ?>" href="#view-modal" id="getCircularInfo" title="Circular Details" data-container="body" data-trigger="hover" data-placement="top">
...
<div id="view-modal" class="modal fade" role="dialog" aria-hidden="true">
    <div class="modal-dialog modal-lg">
        <div class="col-md-12" id="dynamic-content">
...
<script type="text/javascript">
    $(document).on('click', '#getCircularInfo', function (e) {
        e.preventDefault();
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\dysin\resources\views/circular/index.blade.php ENDPATH**/ ?>
        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.VIEW_PARTICIPATED_APPLICATION')); ?>
                ...
                <div class="portlet-body">
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'participatedApplicant/filter', 'class' => '', 'id' => 'jobTitleFilter'))); ?>
                                ...
                                <tr class="contain-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-success btn-xs tooltips recruited" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.RECRUITED')); ?>" data-id ="<?php echo e($value->id); ?>" title="<?php echo e(trans('english.RECRUITED')); ?>" id="recruited_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
...
//                    processData: false,
                    ...
                    success: function (res) {
                        ...
                        location = "<?php echo e(URL::to('/participatedApplicant')); ?>";
                    },
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/participated/index.blade.php ENDPATH**/ ?>
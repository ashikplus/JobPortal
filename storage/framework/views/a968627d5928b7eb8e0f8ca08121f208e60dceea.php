        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i><?php echo e(trans('english.VIEW_REVIEWED_APPLICANT')); ?>
                ...
                <div class="portlet-body">
                    <?php echo e(Form::open(array('role' => 'form', 'url' => 'reviewed/filter', 'class' => '', 'id' => 'jobTitleFilter'))); ?>
...
<!--                                    <td class="text-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-danger btn-xs tooltips discard" data-rel="tooltip" data-toggle="modal" data-target="#viewModal" data-id="<?php echo e($value->id); ?>" href="#viewModal" id="discard_<?php echo e($value->id); ?>" title="<?php echo e(trans('english.DISCARD')); ?>" data-container="body" data-trigger="hover" data-placement="top">

                                                &nbsp;<i class='fa fa-ban'></i>&nbsp;
                                            </a>
                                            <a class="btn btn-success btn-xs tooltips select-for-interview" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.SELECT_FOR_INTERVIEW')); ?>" data-id ="<?php echo e($value->id); ?>" title="<?php echo e(trans('english.SELECT_FOR_INTERVIEW')); ?>" id="selectForInterview_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
                                                <i class="fa fa-check"></i>
                                            </a>
                                            <a class="btn btn-warning btn-xs tooltips application-details" data-toggle="modal" data-target="#viewModal2" href="#viewModal2" data-placement="top" data-rel="tooltip" data-original-title="<?php echo e(trans('english.VIEW_APPLICATION_DETAILS')); ?>" data-id ="<?php echo e($value->id); ?>" title="<?php echo e(trans('english.VIEW_APPLICATION_DETAILS')); ?>" id="applicationDetails_<?php echo e($value->id); ?>" data-container="body" data-trigger="hover" data-placement="top">
            ...
            if (isConfirm) {
                ...
                $.ajax({
                    ...
                    success: function (res) {
                        ...
                        location = "<?php echo e(URL::to('/reviewedApplication')); ?>";
                    },
                    error: function (jqXhr, ajaxOptions, thrownError) {
                        if (jqXhr.status == 400) {
                            var errorsHtml = '';
...
//                var formData = new FormData($("#discardApplicationForm")[0]);
                ...
                $.ajax({
                    url: "<?php echo e(URL::to('applicant/applicant-selected')); ?>",
                    type: "POST",
                    dataType: 'json', // what to expect back from the PHP script, if anything
//                    cache: false,
//                    contentType: false,
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH E:\xampp-7.4.9\htdocs\swapnoloke\resources\views/reviewed/index.blade.php ENDPATH**/ ?>
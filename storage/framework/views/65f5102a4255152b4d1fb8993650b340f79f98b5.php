...
<html lang="en">
    <head>
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/vendor/line-awesome/line-awesome/line-awesome/css/line-awesome.min.css')); ?>">
        ...
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/plugins/owl-carousel/owl.carousel.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/plugins/magnific-popup/magnific-popup.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/plugins/jquery.countdown.css')); ?>">
        <!-- Main CSS File -->
        <link href="<?php echo e(asset('public/css/gallery/lightgallery.css')); ?>" rel="stylesheet" type="text/css" />
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/style.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/skin-dysin.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/dysin.css')); ?>">
        <link rel="stylesheet" href="<?php echo e(asset('public/frontend/assets/css/custom.css')); ?>">
        ...
        <!-- Favicon -->
        <link rel="shortcut icon" href="<?php echo e(URL::to('/')); ?>/public/img/swapnoloke.png" />
        <!--jquery-->
...
<!--        <script src="<?php echo e(asset('public/js/jquery-ui.min.js')); ?>" type="text/javascript"></script>
        ...
        <link href="<?php echo e(asset('public/assets/global/plugins/bootstrap-fileinput/bootstrap-fileinput.css')); ?>" type="text/css" />
    </head>
                ...
                <div class="container-fluid">
                    <div class="row">
                        <div class="col-auto col-lg-2 col-xl-2 col-xxl-1 header-right">
                            <a href="<?php echo e(URL::to('/')); ?>"  class="logo" style="display:block;text-align:center;">
                                <!--<img style="display:inline-block;" src="<?php echo e(asset('public/img/site_logo.png')); ?>" alt="Logo" width="77" height="100">-->
                            </a>
                                        ...
                                        if (Auth::check()) {
                                            ...
                                            <!--                                        
                                                ...
                                                <a href="<?php echo e(route('logout')); ?>" onclick="event.preventDefault();
                                                    ...
                                                    <?php echo e(trans('english.LOGOUT')); ?>
                                            ...
                                            <!--
    <li class="level1">
        <a class="" id="menu-36" href="<?php echo e(URL::to('/').'/login'); ?>"><?php echo e(trans('english.LOGIN')); ?></a>
    </li>
                                            -->
                                            <?php
                                        }
...
<?php /**PATH E:\xampp-7.4.9\htdocs\swapnoloke\resources\views/website/layouts/header.blade.php ENDPATH**/ ?>
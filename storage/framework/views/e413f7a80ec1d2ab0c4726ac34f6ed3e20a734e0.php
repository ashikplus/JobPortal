...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i><?php echo app('translator')->get('english.SLIDER_MANAGEMENT'); ?>
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="<?php echo e(URL::to('slider/create'.Helper::queryPageStr($qpArr))); ?>"> <?php echo e(trans('english.CREATE_NEW')); ?>
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter"><?php echo app('translator')->get('english.SLIDER_IMAGE'); ?></th>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->img_d_x)) { ?>
                                    <img width="150" height="70" src="<?php echo e(URL::to('/')); ?>/public/uploads/website/slider/<?php echo e($target->img_d_x); ?>" alt="<?php echo e($target->caption); ?>"/>
                                <?php } else { ?>
                                    <img width="150" height="70" src="<?php echo e(URL::to('/')); ?>/public/img/unknown.png" alt="<?php echo e($target->full_name); ?>"/>
                                <?php } ?>
                            </td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    <?php echo e(Form::open(array('url' => 'slider/' . $target->id, 'id'=>'delete'))); ?>

                                    <?php echo e(Form::hidden('_method', 'DELETE')); ?>

                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="<?php echo e(URL::to('slider/' . $target->id . '/edit'.Helper::queryPageStr($qpArr))); ?>">
...
<?php echo $__env->make('layouts.default', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\xampp\htdocs\swapnoloke\resources\views/website/slider/index.blade.php ENDPATH**/ ?>
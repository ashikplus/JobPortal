        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('english.CREATE_SCROLL_MESSAGE')}} </div>
                    <div class="tools">
                        ...
                        <div class="row">
                            <div class="col-md-7">
								<div class="form-group">
                                    <label class="col-md-4 control-label align-middle">{{trans('english.SELECT_SCOPE')}} : <span class="required"> *</span></label>
                                    <div class="col-md-5">
										...
										<div class="md-checkbox margin-bottom-10">
											<input type="checkbox" name="scope[]" class="checkboxes" id="jcsc" value="2">
											<label for="jcsc">
												<span class="inc"></span>
												<span class="check"></span>
                                ...
                                <div class="form-group">
                                    <label class="col-md-4 control-label">{{trans('english.MESSAGE')}} : <span class="required"> *</span></label>
                                    <div class="col-md-8">

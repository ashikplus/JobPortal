        ...
        <div class="col-md-12">
            <div class="portlet box green">
                ...
                <div class="portlet-body form">
                                ...
                                <tr>
                                    <td>
                                        <address class="text-left">
                                            <strong>{{trans('english.NAME')}}: </strong>{{ $userInfo->first_name }} {{ $userInfo->last_name }}<br />
                                            <strong>{{trans('english.DESIGNATION')}}: </strong>{{$userInfo->designation->title}}<br />
                                            <strong>{{trans('english.APPOINTMENT')}}: </strong>{{$userInfo->appointment->title}}<br />
                                            <strong>{{trans('english.BRANCH')}}: </strong>{{!empty($userInfo->branch->name) ? $userInfo->branch->name: ''}}<br />
                                        </address>
                                    </td>
                                </tr>
                            </table>
                    ...
                    <!-- BEGIN FORM-->
                    {{ Form::open(array('role' => 'form', 'url' => 'users/pup', 'files'=> true, 'class' => 'form-horizontal','id'=>'pup')) }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-7">

...
<html lang="en">
    ...
    <head>
		...
		<link href="{{asset('public/assets/title/title.css')}}" rel="stylesheet" type="text/css" />
        <link href="{{asset('public/assets/pages/css/login2.min.css')}}" rel="stylesheet" type="text/css" />
...
<![endif]-->
        ...
        <script src="{{asset('public/assets/pages/scripts/login.min.js')}}" type="text/javascript"></script>
		 <script src="{{asset('public/js/login/particles.min.js')}}" type="text/javascript"></script>
       <!-- <script src="{{asset('public/js/login/stats.min.js')}}" type="text/javascript"></script>-->
        <script src="{{asset('public/js/login/particlesRun.min.js')}}" type="text/javascript"></script>

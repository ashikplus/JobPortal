...
<html lang="en">
    <head>
        ...
        <meta content="@lang('label.DYSIG_GROUP')" name="description" />
        ...
        <link href="{{asset('public/assets/pages/css/pricing.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link href="{{asset('public/assets/layouts/layout/css/themes/darkblue.min.css')}}" rel="stylesheet" type="text/css" />
        ...
        <link rel="shortcut icon" type="image/icon" href="{{URL::to('/')}}/public/img/swapnoloke.png"/>
        <?php
        $currentControllerName = Request::segment(1);
        $action = Request::segment(2);
        ?>
        @if(($currentControllerName == 'tae' && $action == '') ||
       ...
       <script src="{{asset('public/js/jquery.newsTicker.js')}}" type="text/javascript"></script>
    </head>
    ...
    <body class="page-header-fixed page-sidebar-closed-hide-logo page-container-bg-solid page-content-white">
       ...
       <script src="{{asset('public/assets/global/plugins/bootstrap-datepicker/js/bootstrap-datepicker.js')}}" type="text/javascript"></script>
       ...
       <script src="{{asset('public/assets/pages/scripts/custom.js')}}" type="text/javascript"></script>

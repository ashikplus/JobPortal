...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.UPDATE_TORCH_BEARER')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('torchbearer.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    {!! Form::text('from', !empty($target->from)? Helper::formatDate($target->from):null, ['id'=> 'fromDate', 'class' => 'form-control datepicker2', 'placeholder' => 'DD MM YYYY' ]) !!} 
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-5">
                                <div class="input-group">
                                    {!! Form::text('to', !empty($target->to)? Helper::formatDate($target->to):null, ['id'=> 'toDate', 'class' => 'form-control datepicker2', 'placeholder' => 'DD MM YYYY' ]) !!} 
                                    <span class="input-group-btn">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-md-7">
                                <div class="cv">
                                    @if(!empty($target->oc_image))
                                    <img src="{{URL::to('/')}}/public/uploads/website/{{ $target->oc_image }}" alt=""/>
                                    @else

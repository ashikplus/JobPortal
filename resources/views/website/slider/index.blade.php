...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.SLIDER_MANAGEMENT')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('slider/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.SLIDER_IMAGE')</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->img_d_x)) { ?>
                                    <img width="150" height="70" src="{{URL::to('/')}}/public/uploads/website/slider/{{$target->img_d_x}}" alt="{{ $target->caption}}"/>
                                <?php } else { ?>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'slider/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('slider/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

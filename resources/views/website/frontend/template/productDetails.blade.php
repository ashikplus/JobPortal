        ...
        <div class="row">
            ...
            <div class="col-md-9 details-div">
                ...
                <div class="regular-price">
                    @if(!empty($productInfo->check_special_price))
                    <h3 class="font-orange"><span>&#2547;</span>  {!! $productInfo->special_price??'' !!}</h3>
                    <del> <span>&#2547;</span>  {!! $productInfo->price??'' !!}</del>
                    @else
                    <h3 class="font-orange"><span>&#2547;</span> {!! $productInfo->price??'' !!}</h3>
                    @endif
                </div>

...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.NEWS_AND_EVENTS')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('newsAndEvents/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.FEATURED_IMAGE')</th>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->featured_image)) { ?>
                                    <img width="150" height="70" src="{{URL::to('/')}}/public/uploads/website/NewsAndEvents/{{$target->featured_image}}" alt="{{ $target->caption}}"/>
                                <?php } else { ?>
                                    <img width="150" height="70" src="{{URL::to('/')}}/public/img/no-image.png" alt="{{ $target->full_name}}"/>
                                <?php } ?>
                            </td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'newsAndEvents/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('newsAndEvents/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

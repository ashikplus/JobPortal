        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('english.WHO_WE_ARE')}} </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{ Form::model($whoWeAreArr, array('route' => array('whoWeAre.update'), 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'whoWeAreUpdate')) }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::text('title', !empty($whoWeAreArr->title) ? $whoWeAreArr->title : '', array('id'=> 'title', 'class' => 'form-control', 'placeholder' => 'Type Title')) }}
                                    </div>
                                </div>				
				<div class="form-group">
                                    <label class="col-md-2 control-label">{{trans('english.CONTENT')}} :</label>
                                    <div class="col-md-10">
                                        {{ Form::textarea('content', !empty($whoWeAreArr->content) ? $whoWeAreArr->content : '', ['class' => 'form-control summernote_1','size' => '50x5','id'=>'content']) }}                         
                                    </div>
                                </div>
                            </div>
                        </div>

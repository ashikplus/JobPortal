...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.OUR_PROGRAM')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('ourPrograms/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.CODE')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">{{ $target->program_code }}</td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    ...
                                    {{ Form::open(array('url' => 'ourPrograms/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-warning tooltips" title="D-Care Slide" href="{{ URL::to('ourPrograms/' . $target->id . '/gallery') }}">
                                        <i class="fa fa-image"></i>
                                    </a>
                            
                                    
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('ourPrograms/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

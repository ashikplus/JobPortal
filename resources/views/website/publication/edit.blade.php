...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-book"></i>@lang('english.UPDATE_PUBLICATION')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => ['publication.update', $target->id], 'method' => 'PATCH','files'=> true, 'class' => 'form-horizontal'] ) !!}
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-9">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-4" for="file">@lang('english.UPLOAD_FILE') :</label>
                            <div class="col-md-7">
                    ...
                    <div class="col-md-3"> 
                        ...
                        <img class="display-edit-image" width="200" height="150" src="{{URL::to('/')}}/public/uploads/website/publication/{{$target->image}}" alt="{{ $target->title}}"/>
                        @else
                        <img class="display-edit-image" width="200" height="150" src="{{URL::to('/')}}/public/img/no-image.png" alt="{{ $target->name}}"/>
                        @endif

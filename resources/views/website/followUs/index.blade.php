...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.SOCIAL_LINKS')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('follow-us/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.ICON')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter"><i class="{{ $target->icon }}" style="font-size:24px; font-weight: 600;"></i></td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'follow-us/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('follow-us/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

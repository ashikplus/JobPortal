...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>{{ $programName }} Features
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('programFeatures/'.$id.'/create') }}"> {{trans('english.CREATE_NEW')}}
        ...
        <div class="portlet-body">
            ...
            <div class="table-responsive">
                <table class="table table-bordered table-hover program-features">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.FEATURE_TYPE')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">{{ $featureTypeArr[$target->feature_type] }}</td>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'programFeatures/destroy', 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'POST') }}
                                    {{ Form::hidden('id', $target->id) }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('programFeatures/' . $target->id . '/edit')}}">

...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.QUALITY_FACTOR')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('qualityFactor/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter" width="120">@lang('english.ICON')</th>
                            <!-- <th class="text-center vcenter" width="120">@lang('english.FEATURED_ICON')</th> -->
                            ...
                            <!-- <th class="text-center vcenter">@lang('english.QUANTITY')</th> -->
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td class="text-center vcenter">
                                <?php if (!empty($target->icon)) { ?>
                                    <img width="70"  src="{{URL::to('/')}}/public/uploads/website/{{$target->icon}}" alt="{{ $target->title}}"/>
                                <?php } else { ?>
                            ...
                            <!-- <td class="text-center vcenter">
                                <?php if (!empty($target->icon)) { ?>
                                    <img width="50"  src="{{URL::to('/')}}/public/uploads/website/{{$target->icon}}" alt="{{ $target->title}}"/>
                                <?php } else { ?>
                                    <img width="50"  src="{{URL::to('/')}}/public/img/no-image.png" alt="{{ $target->title}}"/>
                                <?php } ?>
                            </td> -->
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'qualityFactor/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('qualityFactor/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

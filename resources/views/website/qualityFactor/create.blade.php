...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.CREATE_QUALITY_FACTOR')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'qualityFactor', 'files'=> true, 'class' => 'form-horizontal')) !!}
            ...
            <div class="form-body">
                <div class="row">
                    <div class="col-md-12">
                        ...
                        <div class="form-group">
                            <label class="control-label col-md-3" for="image">@lang('english.ICON') :<span class="text-danger"> *</span></label>
                            <div class="col-md-7">
                                <div class="cv">
                                ...
                                <!-- input file -->
                                <div class="box mt-10">
                                    <input type="file" name="icon" id="featuredImage">
                        ...
                        <div class="form-group">
                           ...
                           <!--  <div class="form-group">
                            ...
                            <div class="form-group">
                                <label class="control-label col-md-3">{{trans('english.SHORT_DESCRIPTION')}} :</label>
                                <div class="col-md-9">
                                    {{ Form::textarea('short_description', null, ['class' => 'form-control summernote_1','size' => '50x5','id'=>'content']) }}
                                </div>
                            </div>

        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-gift"></i>{{trans('english.BUSINESS_SEGMENTS')}} </div>
                    <div class="tools">
                ...
                <div class="portlet-body form">
                    <!-- BEGIN FORM-->
                    {{ Form::model($businessSegments, array('route' => array('businessSegments.update'), 'method' => 'POST', 'class' => 'form-horizontal', 'id' => 'missionAndVision', 'files' => true)) }}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-12">
                                <div class="form-group">
                                    ...
                                    <div class="col-md-10">
                                        {{ Form::text('title', !empty($businessSegments->title) ? $businessSegments->title : '', array('id'=> 'title', 'class' => 'form-control', 'placeholder' => 'Type Title')) }}
                                    </div>
                                </div>
                                <div class="form-group">
                                    <label class="control-label col-md-2">@lang('english.IMAGE_FOR_SLIDER') :<span class="text-danger"> *</span></label>
                                    <div class="col-md-10">
                                        <div class="fileinput fileinput-new" data-provides="fileinput">
                                            <div class="fileinput-new thumbnail" style="width: 200px; height: 150px;">
                                                @if(!empty($target->featured_image))
                                                <img src="{{asset('public/uploads/website/slider').'/'.$target->featured_image }}" alt=""/>
                                                @else

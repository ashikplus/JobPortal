<div class="modal-content">
    <div class="modal-header">
        <div class="col-md-6">
            <h5 class="modal-title" id="orderModalLabel">@lang('english.SET_ORDER_STATUS')</h5> 
        </div>
        <div class="col-md-6">
                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label class="control-label col-md-4" for="productCategory">@lang('english.SELECT_ORDER_STATUS'):</label>
                                <div class="col-md-6">
                                    {!! Form::select('order_status',$orderStatus, Request::get('order_status'), ['class' => 'form-control js-source-states','id'=>'productCategory']) !!}
                                </div>
                            </div>
                        </div>
                    </div>

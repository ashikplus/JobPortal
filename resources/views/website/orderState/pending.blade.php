...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-cubes"></i>@lang('english.PENDING')
            </div>
            <div class="actions">
            </div>
        </div>
        <div class="portlet-body">
            <!-- Begin Filter-->
            {!! Form::open(array('group' => 'form', 'url' => 'orderSate/pending/pendingFilter','class' => 'form-horizontal')) !!}
            <div class="row">
                <div class="col-md-4">
    ...
    $(document).on("click", "#btn-submit", function () {
        ...
        $.ajax({
            ...
            success: function (res) {
                ...
                setTimeout(window.location.replace('{{ URL::to("orderSate/pending")}}'), 500);

...
<div class="page-content">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'programGallery/update', 'files'=> true, 'class' => 'form-horizontal')) !!}
                ...
                <div class="row">
                    <div class="col-md-12">
                        <div class="form-group last">
                            <label class="control-label col-md-3">@lang('english.IMAGE_FOR_GALLEY') :<span class="text-danger"> *</span></label>
                            <div class="col-md-9">
                                <div class="fileinput fileinput-new" data-provides="fileinput">
                                    <div class="fileinput-new thumbnail" style="width: 200px; height: auto;">
                                        @if($target->image)
                                            <img src="{{URL::to('/')}}/public/uploads/website/programGallery/{{ $target->image }}" alt=""> </div>
                                        @else
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/ourPrograms/'.$target->program_id.'/gallery') }}" class="btn btn-circle btn-outline grey-salsa">@lang('english.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}

...
<div class="page-content">
    ...
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.DOWNLOADS')
            </div>
            <div class="actions">
                <a class="btn btn-default btn-sm create-new" href="{{ URL::to('downloads/create'.Helper::queryPageStr($qpArr)) }}"> {{trans('english.CREATE_NEW')}}
                ...
                <table class="table table-bordered table-hover">
                    <thead>
                        <tr>
                            ...
                            <th class="text-center vcenter">@lang('english.URL')</th>
                    ...
                    <tbody>
                        ...
                        <tr>
                            ...
                            <td  class="text-center vcenter">
                                <div>
                                    {{ Form::open(array('url' => 'important-links/' . $target->id, 'id'=>'delete')) }}
                                    {{ Form::hidden('_method', 'DELETE') }}
                                    <a class="btn btn-icon-only btn-primary tooltips" title="Edit" href="{{ URL::to('important-links/' . $target->id . '/edit'.Helper::queryPageStr($qpArr)) }}">

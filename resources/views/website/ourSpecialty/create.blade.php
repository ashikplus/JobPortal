...
<div class="page-content">
    <div class="portlet box green">
        ...
        <div class="portlet-body form">
            {!! Form::open(array('group' => 'form', 'url' => 'ourSpecialty', 'files'=> true, 'class' => 'form-horizontal')) !!}
            ...
            <div class="form-actions">
                <div class="row">
                    <div class="col-md-offset-4 col-md-8">
                        ...
                        <a href="{{ URL::to('/ourSpecialty'.Helper::queryPageStr($qpArr)) }}" class="btn btn-circle btn-outline grey-salsa">@lang('english.CANCEL')</a>
                    </div>
                </div>
            </div>
            {!! Form::close() !!}

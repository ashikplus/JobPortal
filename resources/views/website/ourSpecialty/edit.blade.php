...
<div class="page-content">
    <div class="portlet box green">
        <div class="portlet-title">
            <div class="caption">
                <i class="fa fa-road"></i>@lang('english.UPDATE_OUR_SPECIALITY')
            </div>
        </div>
        <div class="portlet-body form">
            {!! Form::model($target, ['route' => array('ourSpecialty.update', $target->id), 'method' => 'PATCH', 'files'=> true, 'class' => 'form-horizontal'] ) !!}
                        ...
                        <div class="form-group">
                                    ...
                                    <div class="col-md-8">
                                        ...
                                        @if(!empty($target->featured_image))
                                            <img src="{{asset('public/uploads/website').'/'.$target->featured_image }}" alt=""/>
                                            @else

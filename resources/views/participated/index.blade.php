        ...
        <div class="col-md-12">
            <div class="portlet box green">
                <div class="portlet-title">
                    <div class="caption">
                        <i class="fa fa-cubes"></i>{{trans('english.VIEW_PARTICIPATED_APPLICATION')}}
                    </div>
                    <!--                    <div class="actions">
                ...
                <div class="portlet-body">
                    {{ Form::open(array('role' => 'form', 'url' => 'participatedApplicant/filter', 'class' => '', 'id' => 'jobTitleFilter')) }}
                                ...
                                <tr class="contain-center">
                                    ...
                                    <td class="action-center">
                                        <div class='text-center'>
                                            <a class="btn btn-success btn-xs tooltips recruited" data-placement="top" data-rel="tooltip" data-original-title="{{trans('english.RECRUITED')}}" data-id ="{{$value->id}}" title="{{trans('english.RECRUITED')}}" id="recruited_{{$value->id}}" data-container="body" data-trigger="hover" data-placement="top">
...
//                    processData: false,
                    ...
                    success: function (res) {
                        ...
                        location = "{{ URL::to('/participatedApplicant') }}";
                    },
